      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent">
            Sign in to Pet Universe
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Welcome back to your one-stop pet care solution
          </p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gradient-to-br from-teal-50 via-cyan-50 to-emerald-50 text-gray-500">Or continue with</span>
              </div>
            </div>
